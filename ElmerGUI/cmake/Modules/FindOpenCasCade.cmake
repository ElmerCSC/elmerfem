#shamelessly borrowed from FreeCAD project: https://github.com/FreeCAD/FreeCAD/blob/master/cMake/FindOpenCasCade.cmake
# Try to find OCE / OCC
...
if(NOT DEFINED OCE_DIR)
  ...
  if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    ...
    elseif(DEFINED HOMEBREW_PREFIX)
      find_package(OCE QUIET HINTS ${HOMEBREW_PREFIX}/Cellar/opencascade/*)
    endif()
  elseif(UNIX)
...
if(${ELMER_USE_OCC_VARIANT} MATCHES "Community Edition")
