...
void MainWindow::getStartedSlot() {
  ...
  msgBox.setText(tr(
	...
	"files or gz/tar files.  The forum allows up to 3 attachments per "
	"post and up to 1 Megabyte per post.<BR><BR>"
	"Whatis Context Help<BR>"
	...
	"click the left mouse button inside the data entry box to display the help text.  "
	"Qt also offers an alternate method, where after clicking into a data "
	"entry box, press 'shift F1'.  If text is available, then it will be displayed."
	"</P>"
  ));
  msgBox.exec();
}
