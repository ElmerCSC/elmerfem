  ...
  DO iter=1,NonlinearIter
   ...
   CONTAINS
     ...
     SUBROUTINE LocalMatrix( STIFF, MASS, FORCE,&
       ...
       REAL(KIND=dp) :: NodalGM(nCoord),NodalThick(nCoord)
       LOGICAL :: Stat, UseLinear,PartlyGroundedElement
       INTEGER :: i,j,t,p,q, n
       TYPE(GaussIntegrationPoints_t) :: IntegStuff
       REAL(KIND=dp) :: smbE, bmbE, area, MinH
       REAL(KIND=dp) :: smbAtIP, bmbAtIP, GMatIP, rho, rhow, hh, sealevel
       !------------------------------------------------------------------------------
       ...
       DO t = 1,IntegStuff % n
        ...
        ! limit ..., Comput. Methods Appl. Mech. Engrg. 193 (2004)
          ...
          IF (SEM .AND. PartlyGroundedElement) THEN
             ...
             BMBatIP = SSAEffectiveBMB(Element,IntegStuff%n,Basis,SEM,BMB(1:nCoord),hh,rho,rhow,sealevel)
          END IF
