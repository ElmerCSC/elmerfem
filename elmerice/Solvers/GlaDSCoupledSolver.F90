...
!------------------------------------------------------------------------------
     ...
     SAVE &
          ...
          Calving, LimitEffPres, MaskName, HaveMoulinMask
        ! Load_h dropped from SAVE -- see 5baf9b75e, ValueHandle-based volume
        ! source read-in caused a segfault; reverted to the nodal-wise GetReal
