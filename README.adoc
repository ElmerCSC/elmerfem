...
[.text-center]
[![SQAaaS badge shields.io](https://img.shields.io/badge/sqaaas%20software-silver-lightgrey)](https://api.eu.badgr.io/public/assertions/DNiOnAmjRc-JaiEU_cdn-g "SQAaaS silver badge achieved")
