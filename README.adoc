...
[.text-center]
image:https://img.shields.io/badge/sqaaas%20software-silver-lightgrey?style=flat["SQAaaS silver badge achieved", link=https://api.eu.badgr.io/public/assertions/DNiOnAmjRc-JaiEU_cdn-g]
image:https://zenodo.org/badge/DOI/10.5281/zenodo.7892181.svg?style=social&label=Fork&style=plastic["Zenodo DOI"]
