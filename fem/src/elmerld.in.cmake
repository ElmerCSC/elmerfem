...
cmd="$LD @CMAKE_Fortran_FLAGS@ @CMAKE_SHARED_LIBRARY_Fortran_FLAGS@ @CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS@ $* -L@CMAKE_INSTALL_PREFIX@/lib -L$LIBDIR"
printf "%s " $cmd
printf "\n"
$LD @CMAKE_Fortran_FLAGS@ @CMAKE_SHARED_LIBRARY_Fortran_FLAGS@ @CMAKE_SHARED_LIBRARY_CREATE_Fortran_FLAGS@ $* -L@CMAKE_INSTALL_PREFIX@/lib -L$LIBDIR
