...
!              Element => GetBoundaryElement(t)
        ...
        END SELECT
        CALL AddVariableToCircuit(Comp % ivar, k)
        CALL AddVariableToCircuit(Comp % vvar, k)
      END DO
      ...
      DO i=1,Circuits(p) % n
        ...
        CALL AddVariableToCircuit(Circuits(p) % CircuitVariables(i), k)
      END DO
...
!------------------------------------------------------------------------------
  SUBROUTINE AddVariableToCircuit(Variable, k)
!------------------------------------------------------------------------------
