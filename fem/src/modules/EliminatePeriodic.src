...
!  Ideana oli tehdä matriisit Neumanin reunaehdoilla sekä taulukko
!  R, jossa on solmuarvojen riippuvuudet tyyliin R(i,1) = R(i,2).
!  Saa olla päällekkäisyyksiä ja missä tahansa järjestyksessä. 
!  Kutsuin sitten a.o. aliohjelmaa, joka palauttaa listat d ja
!  Pperm siten, että projektori saadaan seuraavasti:
!
!   P( i, Pperm( d(i) ) ) = 1
!
!  Itseasiassa tuo d on tässä ainoa mikä oikeastaan sisältää 
!  infoa, eli vapausasteiden lopulliset riippuvuudet tyyliin
!
!      i = d(i)
!
!  Ei ole enää N**2 luuppi, vaan ihan N. Testasin aika paljon ja
!  näyttäisi toimivan kyllä ihan hienosti. 
!
!  Tuo 3d on sinänsä hankala, että ongelmia ei tule pelkästään
!  nurkkapisteistä kuten 2d:ssä, vaan myös kaikista särmistä, 
!  eli toiststaan riippuvia rajoitteita on itseasiassa läjäpäin.
!
!  Tuskin tosta edelleenkään on mitään lopullista iloa, heitä
!  roskiin jos siltä tuntuu. Ja eihän toi edes toimi muuten kuin
!  kahden solmun välisille rajoitteille, mitään yleisempää sillä
!  ei voi tehdä.
!
!  Mikko
