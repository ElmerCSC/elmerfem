...
!------------------------------------------------------------------------------
  ...
  INTEGER :: i,j,k,l,n,dim,Dofs,dof,itop,ibot,idown,iup,jup,lup,ii,jj,mi,mii,Rounds,nsize,layer, &
      nnodes, ActiveDirection,elem,TopNodes,MidNodes,NoVar,BotNodes, NormInd
