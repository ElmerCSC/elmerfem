...
! *  Inherits most of the code from IncompressibleNS module.
! *
! *  Named "HydrostaticNS" -- formerly "HydrostaticNSVec"; that name now fronts
! *  this file (see HydrostaticNSVec.F90) purely so sifs naming it directly
! *  keep working.
! *
