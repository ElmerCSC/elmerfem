...
cmd="$FC @CMAKE_Fortran_FLAGS@ @ELMER_F90FLAGS@ @CMAKE_SHARED_LIBRARY_Fortran_FLAGS@ -I$INCLUDE $*"
printf "%s " $cmd
printf "\n"
$FC @CMAKE_Fortran_FLAGS@ @ELMER_F90FLAGS@ @CMAKE_SHARED_LIBRARY_Fortran_FLAGS@ -I$INCLUDE $*
