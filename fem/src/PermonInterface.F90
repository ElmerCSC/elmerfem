MODULE PermonInterface
  ...
  INTERFACE
    SUBROUTINE permon_solve(rows, cols, vals, nrows, ncols, b_ptr, limits_ptr, &
                 x_ptr, bound, globaldofs_ptr, owner_ptr) BIND(C, NAME="permon_solve")
      ...
      TYPE(C_PTR), VALUE :: globaldofs_ptr
      TYPE(C_PTR), VALUE :: owner_ptr
