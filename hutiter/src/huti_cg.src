...
MAKE_DEFINE(#,define, Z, work(:,1) )
MAKE_DEFINE(#,define, Z_ind, 1 )
MAKE_DEFINE(#,define, P, work(:,2) )
MAKE_DEFINE(#,define, P_ind, 2 )
MAKE_DEFINE(#,define, Q, work(:,3) )
MAKE_DEFINE(#,define, Q_ind, 3 )
MAKE_DEFINE(#,define, R, work(:,4) )
MAKE_DEFINE(#,define, R_ind, 4 )
!*************************************************************************
...
recursive subroutine MAKE_SUBRN( huti_,cgsolv ) ( ndim, wrkdim, xvec, rhsvec, &
  ...
  F_PRECISION_TYPE :: alpha, beta, rho, oldrho
  integer iter_count
...
end subroutine MAKE_SUBRN( huti_,cgsolv )
