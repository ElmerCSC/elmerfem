# shamelessly borrowed from the eigen project
# https://bitbucket.org/eigen/eigen/src/default/cmake/FindMetis.cmake

# Pastix
#
# @copyright (c) 2009-2014 The University of Tennessee and The University of
# Tennessee Research Foundation. All rights reserved. @copyright (c) 2012-2014
# Inria. All rights reserved. @copyright (c) 2012-2014 Bordeaux INP, CNRS (LaBRI
# UMR 5800), Inria, Univ. Bordeaux. All rights reserved.
#
# * Find METIS include dirs and libraries Use this module by invoking
#   find_package with the form: find_package(METIS [REQUIRED]             # Fail
#   with error if metis is not found )
#
# This module finds headers and metis library. Results are reported in
# variables: METIS_FOUND           - True if headers and requested libraries
# were found METIS_INCLUDE_DIRS    - metis include directories
# METIS_LIBRARY_DIRS    - Link directories for metis libraries METIS_LIBRARIES -
# metis component libraries to be linked
#
# The user can give specific paths where to find the libraries adding cmake
# options at configure (ex: cmake path/to/project -DMETIS_DIR=path/to/metis):
# METIS_DIR             - Where to find the base directory of metis METIS_INCDIR
# - Where to find the header files METIS_LIBDIR          - Where to find the
# library files The module can also look for the following environment variables
# if paths are not given as cmake variable: METIS_DIR, METIS_INCDIR,
# METIS_LIBDIR

# =============================================================================
# Copyright 2012-2013 Inria Copyright 2012-2013 Emmanuel Agullo Copyright
# 2012-2013 Mathieu Faverge Copyright 2012      Cedric Castagnede Copyright 2013
# Florent Pruvost
#
# Distributed under the OSI-approved BSD License (the "License"); see
# accompanying file MORSE-Copyright.txt for details.
#
# This software is distributed WITHOUT ANY WARRANTY; without even the implied
# warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
# License for more information.
# =============================================================================
# (To distribute this file outside of Morse, substitute the full License text
...
if(METIS_LIBRARIES)
  ...
  string(REGEX REPLACE "^ -" "-" CMAKE_REQUIRED_LIBRARIES
  ...
  if(NOT METIS_WORKS)
    if(NOT METIS_FIND_QUIETLY)
      ...
      message(
        STATUS "Check in CMakeFiles/CMakeError.log to figure out why it fails")
    endif()
  endif()
...
if(METIS_LIBRARIES)
  ...
  if(${first_lib_path} MATCHES "/lib(32|64)?$")
    ...
    set(METIS_DIR_FOUND
        "${not_cached_dir}"
        CACHE PATH "Installation directory of METIS library" FORCE)
  else()
    set(METIS_DIR_FOUND
        "${first_lib_path}"
        CACHE PATH "Installation directory of METIS library" FORCE)
...
find_package_handle_standard_args(METIS DEFAULT_MSG METIS_LIBRARIES METIS_WORKS)
#
