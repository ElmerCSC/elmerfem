...
/*******************************************************************************
 *
 *     Name:        elm_4node_triangle_triangulate( geometry_t *,element_t * )
 *
 ...
 *
 ******************************************************************************/
int elm_4node_triangle_triangulate( geometry_t *geom, element_t *Elm, element_t *Parent)
{
    double u,v,w,s;
...
/*******************************************************************************
 *
 *     Name:        elm_4node_triangle_point_inside(
 ...
 *
 ******************************************************************************/
int elm_4node_triangle_point_inside
   ( 
                   double *nx, double *ny, double *nz,
   ...
   )
{
    ...
    if ( ABS(detA) < AEPS )
    {
        fprintf( stderr, "4node_triangle_inside: SINGULAR, HUH? \n" );
        return FALSE;
    }
...
/*******************************************************************************
 *
 *     Name:        elm_4node_triangle_fvalue( double *,double,double )
 *
 ...
 *
 ******************************************************************************/
static double elm_4node_triangle_fvalue(double *F,double u,double v)
{
...
/*******************************************************************************
 *
 *     Name:        elm_4node_triangle_dndu_fvalue( double *,double,double )
 *
 ...
 *
 ******************************************************************************/
static double elm_4node_triangle_dndu_fvalue(double *F,double u,double v)
{
    return -F[0] + F[1];
}
...
/*******************************************************************************
 *
 *     Name:        elm_4node_triangle_dndv_fvalue( double *,double,double )
 *
 ...
 *
 ******************************************************************************/
static double elm_4node_triangle_dndv_fvalue(double *F,double u,double v)
{
     return -F[0] + F[2];
}
...
/*******************************************************************************
 *
 *     Name:        elm_4node_triangle_isoline
 *
 ...
 *
*******************************************************************************/
int elm_4node_triangle_isoline
  (
...
/*******************************************************************************
 *
 *     Name:        elm_4node_triangle_initialize()
 *
...
int elm_4node_triangle_initialize()
{
     ...
     ElementDef.PartialU = (double (*)())elm_4node_triangle_dndu_fvalue;
     ElementDef.PartialV = (double (*)())elm_4node_triangle_dndv_fvalue;
     ElementDef.PartialW = (double (*)())NULL;

     ElementDef.FunctionValue = (double (*)())elm_4node_triangle_fvalue;
     ElementDef.Triangulate   = (int (*)())elm_4node_triangle_triangulate;
     ElementDef.IsoLine       = (int (*)())elm_4node_triangle_isoline;
     ElementDef.PointInside   = (int (*)())elm_4node_triangle_point_inside;
