...
# Setup options.
option(METIS_GDB "enable use of GDB" OFF)
option(METIS_ASSERT "turn asserts on" OFF)
option(METIS_ASSERT2 "additional assertions" OFF)
option(METIS_DEBUG "add debugging support" OFF)
option(METIS_GPROF "add gprof support" OFF)
option(METIS_OPENMP "enable OpenMP support" OFF)
option(METIS_PCRE "enable PCRE support" OFF)
option(METIS_GKREGEX "enable GKREGEX support" OFF)
option(METIS_GKRAND "enable GKRAND support" OFF)

mark_as_advanced(GKLIB_PATH METIS_GDB METIS_ASSERT
    METIS_ASSERT2 METIS_DEBUG METIS_GPROF METIS_OPENMP
    METIS_PCRE METIS_GKREGEX METIS_GKRAND)
...
# GCC warnings.
set(GKlib_COPTIONS "${GKlib_COPTIONS} -Wall -pedantic -Wno-unused-but-set-variable -Wno-unused-variable -Wno-unknown-pragmas -Wno-misleading-indentation")
